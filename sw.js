...
const CACHE_NAME = "skinquest-cache-v1510";
const APP_SHELL = [
  "skinquest-v14.css?v=1505",
  "skinquest-v14.js?v=1510",
  "/skinquest-v146.css?v=1505", "/skinquest-v146.js?v=1505",
  "/skinquest-v15.css?v=1505", "/skinquest-v15.js?v=1510",
  ...
  "/skinquest-v1510.css?v=1510", "/skinquest-giveaways.js?v=1510",
  "offline.html",
  "/", "/surveys", "/giveaways", "/earn", "/rewards", "/how-it-works", "/install",
  "/styles.css?v=1505", "/app.js?v=1510", "/manifest.json",
  "/admin.css?v=1505", "/admin.js?v=1510",
