...
const CACHE_NAME = "skinquest-cache-v1456";
const APP_SHELL = [
  "skinquest-v14.css?v=1456",
  "skinquest-v14.js?v=1456",
  "offline.html",
  "/", "/surveys", "/rewards", "/how-it-works", "/install", "/admin",
  "/styles.css?v=1456", "/app.js?v=1456", "/manifest.json",
  "/admin.css?v=1456", "/admin.js?v=1456",
