...
const CACHE_NAME = "skinquest-cache-v1450";
const APP_SHELL = [
  "skinquest-v14.css?v=1450",
  "skinquest-v14.js?v=1450",
  "offline.html",
  "/", "/surveys", "/rewards", "/how-it-works", "/install", "/admin",
  "/styles.css?v=1450", "/app.js?v=1450", "/manifest.json",
  "/admin.css?v=1450", "/admin.js?v=1450",
