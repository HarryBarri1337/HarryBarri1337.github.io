-- SkinQuest existing-project upgrade to v12.2.9
-- Run this on the current Supabase project.
-- This is a complete, idempotent schema synchronization: it preserves existing data,
-- adds missing tables/columns, replaces every SkinQuest function/policy/grant, and
-- updates both Trade URL saving and reward redemption.
