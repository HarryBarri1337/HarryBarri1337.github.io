-- SkinQuest full Supabase setup v14.0.0
...
-- ============================================================================
-- SkinQuest v14.0.0 product layer (included in full fresh-project setup)
-- Everything below is also contained in skinquest_upgrade_existing_to_v14_0_0.sql.
...
begin
  if to_regclass('public.profiles') is null
    ...
    raise exception 'SkinQuest v14 upgrade requires the existing v13.1.0 database schema. Use skinquest_full_setup_v14_0_0.sql only for a NEW empty Supabase project.';
  end if;
end $$;
