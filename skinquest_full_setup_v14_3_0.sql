-- SkinQuest full Supabase setup v14.3.0
...
begin
  if to_regclass('public.profiles') is null
    ...
    raise exception 'SkinQuest setup requires the existing core schema. Use skinquest_full_setup_v14_3_0.sql only for a NEW empty Supabase project.';
  end if;
end $$;
